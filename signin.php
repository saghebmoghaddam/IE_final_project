...
<section class="form__section">
    <div class="container form__section-container">
        ...
        <form action="<?= ROOT_URL ?>signin-logic.php" method="POST">
            <input type="text" name="username_email" value='<?= $username_email ?>' placeholder="نام کاربری یا ایمیل">
            <input type="password" name="password" value='<?= $password ?>' placeholder="رمز عبور">
            <button type="submit" class="btn" name="submit">ورود</button>
            <small>حساب کاربری ندارید؟ <a href="signup.php">ثبت نام کنید</a></small>
        </form>
    </div>
</section>
</body>
