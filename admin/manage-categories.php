    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<?= ROOT_URL ?>admin/edit-category.php?id=<?=$category['id']?>" class="btn sm">ویرایش</a></td>
                <td><a href="<?= ROOT_URL ?>admin/delete-category.php?id=<?=$category['id']?>" class="btn sm danger">حذف</a></td>
            </tr>
            <?php endwhile ?>
        </tbody>
    <?php else : ?>
