        ...
        <?php if ((mysqli_num_rows($posts)) > 0 ): ?>
            ...
            <tbody>
                <?php while($post = mysqli_fetch_assoc($posts)) : ?>
                    <!-- دریافت عنوان دسته بندی هر پست از جدول دسته بندی -->
                    <?php
                ...
                <tr>
                    ...
                    <td><a href="<?= ROOT_URL ?>admin/edit-post.php?id=<?= $post['id'] ?>" class="btn sm">ویرایش</a></td>
                    <td><a href="<?= ROOT_URL ?>admin/delete-post.php?id=<?= $post['id'] ?>" class="btn sm danger">حذف</a></td>
                </tr>
                <?php endwhile ?>
                
            </tbody>
        <?php else :?>
            <div class="alert alert__message error"><?= "پستی یافت نشد" ?></div>
        <?php endif?>
        </table>
    </main>
</div>
